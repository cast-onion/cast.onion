...
pub struct GuestBroadcaster {
    pub running: Arc<AtomicBool>,
}

impl GuestBroadcaster {
    pub fn start(
        room_id: &str,
        guest_id: &str,
        device_name: &str,
        ...
        let request = format!(
            "POST /v1/room/{}/stream HTTP/1.1\r\nHost: {}:{}\r\nX-Guest-ID: {}\r\nContent-Type: audio/ogg\r\nExpect: 100-continue\r\n\r\n",
            room_id, API_HOST, API_PORT, guest_id
        );
        ...
        std::thread::spawn(move || {
            ...
            let clean = crate::broadcast::extract_pactl_name(&device_name);
            ...
            let device = match device {
                Some(d) => d,
                None => { on_error("no input device".into()); return; }
            };
